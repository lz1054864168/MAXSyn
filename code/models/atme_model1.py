...
class AtmeModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:  # define a discriminator; conditional GANs need to take both input and output images; Therefore, #channels for D is input_nc + output_nc
            ...
            # self.load_net(self.netG, r'D:\LZ_project\atme-main\models\facades_BA\latest_net_G.pth')
            # self.load_net(self.netD, r'D:\LZ_project\atme-main\models\facades_BA\latest_net_D.pth')
            # self.load_net(self.netW, r'D:\LZ_project\atme-main\models\facades_BA\latest_net_T.pth')
    ...
    def backward_G(self):
        ...
        self.loss_W_FFL = self.FFLoss(self.fake_B, self.real_B) * self.opt.lambda_L1
        # combine loss and calculate gradients 
        self.loss_G = self.loss_G_GAN + self.loss_G_L1 + self.loss_W_FFL
    ...
    def optimize_parameters(self):
        ...
        self.optimizer_W.zero_grad()        # set G's gradients to zero
